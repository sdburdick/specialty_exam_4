...
namespace mixr {
    ...
    bool CPR_Generator_Proactor::shutdownNotification()
    {
        //note - in MixR, this call will be made at the point of the GUI getting closed.  This
        //work needs to be done to let the backlog of messages clear and the thread to close out before destruction
    ...
    void CPR_Generator_Proactor::transmit_CPR_for_client(ProactorClient* c)
    {
